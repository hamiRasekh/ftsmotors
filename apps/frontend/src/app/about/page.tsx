            ...
            <FadeIn>
              <div className="text-center mb-12 max-w-3xl mx-auto">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  فیدار تجارت سوبا با بیش از 20 سال تجربه، یکی از معتبرترین نمایندگی‌های خودرو در کشور است. ما با تکیه بر تجربه و تخصص تیم خود، همواره تلاش کرده‌ایم تا بهترین خودروها را با مناسب‌ترین قیمت‌ها به مشتریان خود ارائه دهیم.
                </p>
              </div>
            </FadeIn>
          </div>
              ...
              <SlideIn direction="right">
                <div>
                  ...
                  <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
                    <p>
                      فیدار تجارت سوبا در سال 2000 با هدف ارائه بهترین خدمات در زمینه خرید و فروش خودرو
                    ...
                    <p>
                      امروز، فیدار تجارت سوبا با داشتن تیمی متخصص و مجرب، آماده ارائه خدمات با کیفیت به تمامی مشتریان عزیز است.
                    </p>
                  </div>
                  <div className="mt-8">
                    <Link
