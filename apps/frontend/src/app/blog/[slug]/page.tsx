          ...
          <div className="container mx-auto px-4 py-16">
            <FadeIn>
              <div className="text-center">
                <h1 className="text-4xl font-bold text-foreground mb-4">مقاله یافت نشد</h1>
                <Link href="/blog" className="text-primary hover:text-secondary underline">
      ...
      <main className="min-h-screen bg-white pt-16">
        <div className="container mx-auto px-4 py-8">
          ...
          <nav className="mb-8 text-sm text-foreground/70">
            ...
            {' / '}
            <Link href="/blog" className="hover:text-foreground transition-colors">مقالات</Link>
            {' / '}
          ...
          <article className="max-w-4xl mx-auto">
            <FadeIn>
              <header className="mb-8">
                ...
                {article.excerpt && (
                  <p className="text-xl text-foreground/80 mb-6 leading-relaxed">{article.excerpt}</p>
                )}
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                publisher: {
                  ...
                  logo: {
                    '@type': 'ImageObject',
                    url: `${process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:3000'}/logos/loho.png`,
                  },
                },
                mainEntityOfPage: {
                  '@type': 'WebPage',
